...
void menu() {
    ...
    do {
        ...
        cout << "Nama: M.Fahrianor "  << endl;
        cout << "NIM: 2409106089 "<< endl;
        cout << "----------------------------------" << endl;
            ...
            case 2:
                ...
                switch (subPilihan) {
                    ...
                    case 3:
                        ...
                        cin >> subPilihan; 
                        deleteMiddle(head, tail, subPilihan);
                        break;
                    default:
                        cout << ">> Pilihan tidak valid" << endl;
                        break;
